    ...
    <section className="text-center space-y-10 animate-fadeIn">
      ...
      <div className="bg-gray-900 p-6 md:p-8 rounded-xl shadow-lg max-w-3xl mx-auto">
        <p className="text-lg text-gray-300">
          Currently interning at <span className="text-green-400 font-semibold">John Deere</span>, previously at <span className="text-blue-400 font-semibold">Mobile Track Solutions</span>.
